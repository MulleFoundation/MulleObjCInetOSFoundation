if( NOT __EXECUTABLE_OBJC_CMAKE__)
   ...
   #
   set_target_properties( MulleObjCOSFoundation
   ...
   #
   add_custom_command(
     TARGET MulleObjCOSFoundation
     POST_BUILD
     COMMAND echo "Your executable \"$<TARGET_FILE:MulleObjCOSFoundation>\" is now ready to run"
     VERBATIM
   )
endif()
