if( NOT __STANDALONE_C_CMAKE__)
   ...
   if( STANDALONE)
      ...
      if( NOT STANDALONE_NAME)
         set( STANDALONE_NAME "MulleObjCOSFoundation-standalone")
      endif()
      set( STANDALONE_DEFINITIONS ${MULLE_OBJC_OSFOUNDATION_DEFINITIONS})
      ...
      if( NOT STANDALONE_ALL_LOAD_LIBRARIES)
         set( STANDALONE_ALL_LOAD_LIBRARIES
            $<TARGET_FILE:MulleObjCOSFoundation>
...
MulleObjCOSFoundation-standalone.c with contents like this to it:
   int  ___mulle_objc_osfoundation_unused__;
and everybody will be happy")
         ...
         add_dependencies( ${STANDALONE_NAME} MulleObjCOSFoundation)
         if( STARTUP_NAME)
