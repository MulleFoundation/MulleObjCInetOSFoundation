if( NOT __CREATE_LOADER_INC_OBJC_CMAKE__)
   ...
   if( CREATE_OBJC_LOADER_INC)
      ...
      add_library( "_3_MulleObjCBSDFoundation" STATIC
         $<TARGET_OBJECTS:_1_MulleObjCBSDFoundation>
      )
      ...
      add_custom_command(
         ...
         COMMAND ${MULLE_OBJC_LOADER_TOOL}
                   ...
                   -c "${CMAKE_BUILD_TYPE}"
                   -o "${OBJC_LOADER_INC}"
                   $<TARGET_FILE:_3_MulleObjCBSDFoundation>
                   ${INHERITED_OBJC_LOADERS}
         DEPENDS $<TARGET_FILE:_3_MulleObjCBSDFoundation>
      ...
      add_dependencies( "_2_MulleObjCBSDFoundation" __objc_loader_inc__)
   endif()
