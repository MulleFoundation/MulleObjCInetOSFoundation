if( NOT __EXECUTABLE_OBJC_CMAKE__)
   ...
   #
   set_target_properties( MulleObjCOSBaseFoundation
   ...
   #
   add_custom_command(
     TARGET MulleObjCOSBaseFoundation
     POST_BUILD
     COMMAND echo "Your executable \"$<TARGET_FILE:MulleObjCOSBaseFoundation>\" is now ready to run"
     VERBATIM
   )
endif()
