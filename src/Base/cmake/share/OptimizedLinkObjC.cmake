if( NOT __OPTIMIZED_LINK_OBJC_CMAKE__)
   ...
   if( OBJC_COVERAGE_OPTIMIZED_LIBS)
      ...
      set( ALL_LOAD_NAME "${CMAKE_STATIC_LIBRARY_PREFIX}_MulleObjCOSBaseFoundation_ObjC${CMAKE_STATIC_LIBRARY_SUFFIX}")
      set( OPTIMIZABLE_LOAD_NAME  "${CMAKE_STATIC_LIBRARY_PREFIX}_MulleObjCOSBaseFoundation_c${CMAKE_STATIC_LIBRARY_SUFFIX}")
      ...
      add_custom_target( "_MulleObjCOSBaseFoundation_optimized_libraries"
      ...
      add_dependencies( MulleObjCOSBaseFoundation "_MulleObjCOSBaseFoundation_optimized_libraries")
   endif()
endif()
