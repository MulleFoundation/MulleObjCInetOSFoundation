if( NOT __STANDALONE_C_CMAKE__)
   ...
   if( STANDALONE)
      ...
      if( NOT STANDALONE_NAME)
         set( STANDALONE_NAME "MulleObjCOSBaseFoundation-standalone")
      endif()
      set( STANDALONE_DEFINITIONS ${MULLE_OBJC_OSBASE_FOUNDATION_DEFINITIONS})
...
MulleObjCOSBaseFoundation-standalone.c with contents like this to it:
   int  ___mulle_objc_osbase_foundation_unused__;
and everybody will be happy")
         ...
         add_dependencies( ${STANDALONE_NAME} MulleObjCOSBaseFoundation)
         if( STARTUP_NAME)
