if( NOT __EXECUTABLE_OBJC_CMAKE__)
   ...
   #
   set_target_properties( MulleObjCDarwinFoundation
   ...
   #
   add_custom_command(
     TARGET MulleObjCDarwinFoundation
     POST_BUILD
     COMMAND echo "Your executable \"$<TARGET_FILE:MulleObjCDarwinFoundation>\" is now ready to run"
     VERBATIM
   )
endif()
