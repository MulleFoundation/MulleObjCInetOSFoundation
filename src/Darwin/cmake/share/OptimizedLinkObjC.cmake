if( NOT __OPTIMIZED_LINK_OBJC_CMAKE__)
   ...
   if( OBJC_COVERAGE_OPTIMIZED_LIBS)
      ...
      set( ALL_LOAD_NAME "${CMAKE_STATIC_LIBRARY_PREFIX}_MulleObjCDarwinFoundation_ObjC${CMAKE_STATIC_LIBRARY_SUFFIX}")
      set( OPTIMIZABLE_LOAD_NAME  "${CMAKE_STATIC_LIBRARY_PREFIX}_MulleObjCDarwinFoundation_c${CMAKE_STATIC_LIBRARY_SUFFIX}")
      ...
      add_custom_target( "_MulleObjCDarwinFoundation_optimized_libraries"
      ...
      add_dependencies( MulleObjCDarwinFoundation "_MulleObjCDarwinFoundation_optimized_libraries")
   endif()
