if( NOT __EXECUTABLE_OBJC_CMAKE__)
   ...
   #
   set_target_properties( MulleObjCFreeBSDFoundation
   ...
   #
   add_custom_command(
     TARGET MulleObjCFreeBSDFoundation
     POST_BUILD
     COMMAND echo "Your executable \"$<TARGET_FILE:MulleObjCFreeBSDFoundation>\" is now ready to run"
     VERBATIM
   )
