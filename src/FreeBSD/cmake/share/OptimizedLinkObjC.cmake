if( NOT __OPTIMIZED_LINK_OBJC_CMAKE__)
   ...
   if( OBJC_COVERAGE_OPTIMIZED_LIBS)
      ...
      set( ALL_LOAD_NAME "${CMAKE_STATIC_LIBRARY_PREFIX}_MulleObjCFreeBSDFoundation_ObjC${CMAKE_STATIC_LIBRARY_SUFFIX}")
      set( OPTIMIZABLE_LOAD_NAME  "${CMAKE_STATIC_LIBRARY_PREFIX}_MulleObjCFreeBSDFoundation_c${CMAKE_STATIC_LIBRARY_SUFFIX}")
      ...
      add_custom_target( "_MulleObjCFreeBSDFoundation_optimized_libraries"
      ...
      add_dependencies( MulleObjCFreeBSDFoundation "_MulleObjCFreeBSDFoundation_optimized_libraries")
   endif()
