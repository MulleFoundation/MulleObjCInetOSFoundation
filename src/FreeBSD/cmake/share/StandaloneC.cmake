if( NOT __STANDALONE_C_CMAKE__)
   ...
   if( STANDALONE)
      ...
      if( NOT STANDALONE_NAME)
         set( STANDALONE_NAME "MulleObjCFreeBSDFoundation-standalone")
      endif()
      set( STANDALONE_DEFINITIONS ${MULLE_OBJC_FREEB_SDFOUNDATION_DEFINITIONS})
...
MulleObjCFreeBSDFoundation-standalone.c with contents like this to it:
   int  ___mulle_objc_freeb_sdfoundation_unused__;
and everybody will be happy")
         ...
         add_dependencies( ${STANDALONE_NAME} MulleObjCFreeBSDFoundation)
         if( STARTUP_NAME)
