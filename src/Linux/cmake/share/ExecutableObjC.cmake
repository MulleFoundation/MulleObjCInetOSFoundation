if( NOT __EXECUTABLE_OBJC_CMAKE__)
   ...
   #
   set_target_properties( MulleObjCLinuxFoundation
   ...
   #
   add_custom_command(
     TARGET MulleObjCLinuxFoundation
     POST_BUILD
     COMMAND echo "Your executable \"$<TARGET_FILE:MulleObjCLinuxFoundation>\" is now ready to run"
     VERBATIM
   )
