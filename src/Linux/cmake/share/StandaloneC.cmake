if( NOT __STANDALONE_C_CMAKE__)
   ...
   if( STANDALONE)
      ...
      if( NOT STANDALONE_NAME)
         set( STANDALONE_NAME "MulleObjCLinuxFoundation-standalone")
      endif()
...
MulleObjCLinuxFoundation-standalone.c with contents like this to it:
...
and everybody will be happy")
         ...
         add_dependencies( ${STANDALONE_NAME} MulleObjCLinuxFoundation)
         if( STARTUP_NAME)
