...
if( NOT MULLE_OBJC_OSBASE_FOUNDATION_HEADER)
   find_file( MULLE_OBJC_OSBASE_FOUNDATION_HEADER NAMES MulleObjCOSBaseFoundation/MulleObjCOSBaseFoundation.h MulleObjCOSBaseFoundation.h)
   message( STATUS "MULLE_OBJC_OSBASE_FOUNDATION_HEADER is ${MULLE_OBJC_OSBASE_FOUNDATION_HEADER}")
   set( ALL_LOAD_HEADER_ONLY_LIBRARIES
      ${MULLE_OBJC_OSBASE_FOUNDATION_HEADER}
      ${ALL_LOAD_HEADER_ONLY_LIBRARIES}
      CACHE INTERNAL "need to cache this"
   )
   if( MULLE_OBJC_OSBASE_FOUNDATION_HEADER)
      # search for DependenciesAndLibraries.cmake to include
      get_filename_component( _TMP_MULLE_OBJC_OSBASE_FOUNDATION_ROOT "${MULLE_OBJC_OSBASE_FOUNDATION_HEADER}" DIRECTORY)
      get_filename_component( _TMP_MULLE_OBJC_OSBASE_FOUNDATION_NAME "${_TMP_MULLE_OBJC_OSBASE_FOUNDATION_ROOT}" NAME)
      get_filename_component( _TMP_MULLE_OBJC_OSBASE_FOUNDATION_ROOT "${_TMP_MULLE_OBJC_OSBASE_FOUNDATION_ROOT}" DIRECTORY)
      get_filename_component( _TMP_MULLE_OBJC_OSBASE_FOUNDATION_ROOT "${_TMP_MULLE_OBJC_OSBASE_FOUNDATION_ROOT}" DIRECTORY)
      message( STATUS "_TMP_MULLE_OBJC_OSBASE_FOUNDATION_NAME is ${_TMP_MULLE_OBJC_OSBASE_FOUNDATION_NAME}")
      message( STATUS "_TMP_MULLE_OBJC_OSBASE_FOUNDATION_ROOT is ${_TMP_MULLE_OBJC_OSBASE_FOUNDATION_ROOT}")
      # search for DependenciesAndLibraries.cmake to include
      foreach( _TMP_MULLE_OBJC_OSBASE_FOUNDATION_NAME IN LISTS _TMP_MULLE_OBJC_OSBASE_FOUNDATION_NAME)
      ...
      message( FATAL_ERROR "MULLE_OBJC_OSBASE_FOUNDATION_HEADER was not found")
   endif()
endif()
