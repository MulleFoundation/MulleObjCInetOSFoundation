if( NOT __EXECUTABLE_OBJC_CMAKE__)
   ...
   #
   set_target_properties( MulleObjCPosixFoundation
   ...
   #
   add_custom_command(
     TARGET MulleObjCPosixFoundation
     POST_BUILD
     COMMAND echo "Your executable \"$<TARGET_FILE:MulleObjCPosixFoundation>\" is now ready to run"
     VERBATIM
   )
endif()
